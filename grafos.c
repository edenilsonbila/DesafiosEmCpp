...
void apresenta(){ 
       ...
       printf("|                                                                             |\n"); 
       printf("|                                                                             |\n"); 
       printf("|                  PARA MELHOR RESOLUCAO, MAXIMIZE A TELA.                    |\n"); 
...
void menu(){ 
       ...
       printf("|                         | 1 - INICIAL!          |                           |\n"); 
       printf("|                         | 2 - INSERIR 1 CIDADE  |                           |\n"); 
       printf("|                         | 3 - INSERIR 10 CIDADES|                           |\n"); 
       printf("|                         | 4 - EDITAR CIDADES    |                           |\n"); 
       printf("|                         | 5 - EXIBIR CIDADES    |                           |\n"); 
       printf("|                         | 6 - INSERIR VOO       |                           |\n"); 
       printf("|                         | 7 - EDITAR  VOO       |                           |\n"); 
       printf("|                         | 8 - EXIBIR VOO        |                           |\n"); 
       printf("|                         | 9 - BUSCAR VOO        |                           |\n"); 
       printf("|                         | 10- FINALIZAR         |                           |\n");               
       ...
       while (resp == 1)  {  
              ...
              switch (opcao){ 
                     ...
                     case 2: 
                          ...
                          printf("\n|_____________________________________________________________________________|\n"); 
                          printf("\n\n     >> ENTRE COM A CIDADE A SER CADASTRADA: "); 
                          fflush(stdin); 
